...
#define __PTR_ALIGN(B, P, A) \
  (sizeof(PTR_INT_TYPE) < sizeof(void *) ? __BPTR_ALIGN((B), (P), (A)) : (void *)__BPTR_ALIGN((PTR_INT_TYPE)(void *)0, (PTR_INT_TYPE)(P), (A)))
...
#define obstack_memory_used(h) _obstack_memory_used(h)
  ...
  #define obstack_object_size(OBSTACK) \
    __extension__({ struct obstack const *__o = (OBSTACK);				\
  ...
  #define obstack_make_room(OBSTACK, length) \
    __extension__({ struct obstack *__o = (OBSTACK);					\
   int __len = (length);						\
  ...
  #define obstack_ptr_grow_fast(OBSTACK, aptr) \
    __extension__({ struct obstack *__o1 = (OBSTACK);					\
  ...
  #define obstack_alloc(OBSTACK, length) \
    __extension__({ struct obstack *__h = (OBSTACK);					\
    ...
    ((h)->temp.tempint = (char *)(obj) - (char *)(h)->chunk,                                        \
     ((((h)->temp.tempint > 0                                                                       \
        && (h)->temp.tempint < (h)->chunk_limit - (char *)(h)->chunk))                              \
          ? (ptrdiff_t)((h)->next_free = (h)->object_base = (h)->temp.tempint + (char *)(h)->chunk) \
