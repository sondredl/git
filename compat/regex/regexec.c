                        ...
                        int node_idx, int str_idx, int max_str_idx)
{
    ...
    if (naccepted > 0 && str_idx + naccepted <= max_str_idx && !STATE_NODE_CONTAINS(sctx->sifted_states[str_idx + naccepted], dfa->nexts[node_idx]))
    ...
    transit_state_bkref(re_match_context_t *mctx, const re_node_set *nodes)
{
    ...
    for (i = 0; i < nodes->nelem; ++i)
    {
        ...
        for (; bkc_idx < mctx->nbkref_ents; ++bkc_idx)
        {
            ...
            if (dest_state == NULL)
            {
                mctx->state_log[dest_str_idx] = re_acquire_state_context(&err, dfa, new_dest_nodes,
                                                                         context);
    ...
    find_collation_sequence_value(const unsigned char *mbs, size_t mbs_len)
{
    ...
    else
    {
        ...
        int32_t extrasize = (const unsigned char *)
                                _NL_CURRENT(LC_COLLATE, _NL_COLLATE_SYMB_EXTRAMB + 1)
                            - extra;
