...
struct rev_info {
	...
	unsigned int dense : 1, prune : 1, no_walk : 1, unsorted_input : 1,
		...
		left_only : 1, right_only : 1, rewrite_parents : 1,
		print_parents : 1, show_decorations : 1, reverse : 1,
		reverse_output_stage : 1, cherry_pick : 1, cherry_mark : 1,
		bisect : 1, ancestry_path : 1,
	...
	unsigned int shown_one : 1, shown_dashes : 1, show_merge : 1,
		show_notes_given : 1, show_notes_by_default : 1,
		show_signature : 1, pretty_given : 1, abbrev_commit : 1,
		abbrev_commit_given : 1, zero_commit : 1, use_terminator : 1,
		missing_newline : 1, date_mode_explicit : 1,
		preserve_subject : 1, force_in_body_from : 1,
...
#define REV_INFO_INIT                                                        \
	{                                                                    \
		...
		.sort_order = REV_SORT_IN_GRAPH_ORDER, .dense = 1,           \
		.max_age = -1, .max_age_as_filter = -1, .min_age = -1,       \
		.skip_count = -1, .max_count = -1, .max_parents = -1,        \
		.expand_tabs_in_log = -1, .commit_format = CMIT_FMT_DEFAULT, \
