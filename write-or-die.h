 ...
 * FSYNC_COMPONENT_NONE identifies data that will not be a persistent part of
 * the repository and so shouldn't be fsynced.
 */
...
#define FSYNC_COMPONENTS_OBJECTS \
	(FSYNC_COMPONENT_LOOSE_OBJECT | FSYNC_COMPONENT_PACK)
...
#define FSYNC_COMPONENTS_DEFAULT                                          \
	((FSYNC_COMPONENTS_OBJECTS | FSYNC_COMPONENTS_DERIVED_METADATA) & \
	 ~FSYNC_COMPONENT_LOOSE_OBJECT)

#define FSYNC_COMPONENTS_COMMITTED \
	(FSYNC_COMPONENTS_OBJECTS | FSYNC_COMPONENT_REFERENCE)

#define FSYNC_COMPONENTS_ADDED \
	(FSYNC_COMPONENTS_COMMITTED | FSYNC_COMPONENT_INDEX)
