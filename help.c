                       ...
                       struct cmdnames *other_cmds)
{
    ...
    if (env_path)
    {
        ...
        while (1)
        {
            ...
            if (!exec_path || strcmp(path, exec_path) != 0)
            {
...
{
    const struct cmdname *const        *c1 = p1;
    const struct cmdname *const *const *c2 = p2;
    const char                         *s1 = (*c1)->name;
    const char                         *s2 = (*c2)->name;
    int                                 l1 = (*c1)->len;
    int                                 l2 = (*c2)->len;
